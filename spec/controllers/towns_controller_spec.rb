  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created town" do
        post :create, {:town => valid_attributes}, valid_session
        expect(response).to redirect_to(Town.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved town as @town" do
        post :create, {:town => invalid_attributes}, valid_session
        expect(assigns(:town)).to be_a_new(Town)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested town" do
        town = Town.create! valid_attributes
        put :update, {:id => town.to_param, :town => new_attributes}, valid_session
        town.reload
      ...
      it "redirects to the town" do
        town = Town.create! valid_attributes
        put :update, {:id => town.to_param, :town => valid_attributes}, valid_session
        expect(response).to redirect_to(town)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the town as @town" do
        town = Town.create! valid_attributes
        put :update, {:id => town.to_param, :town => invalid_attributes}, valid_session
        expect(assigns(:town)).to eq(town)
      end
